...
lasso_data <- read_excel("~/Desktop/hgg-pnet_features/hgg_pnet_sp_t1t2.xlsx")
...
```{r}
write.csv(as.data.frame(as.matrix(AllCoeffs)), file = "~/Desktop/hgg-pnet_LASSO.csv") ## may not write if path is incorrect
