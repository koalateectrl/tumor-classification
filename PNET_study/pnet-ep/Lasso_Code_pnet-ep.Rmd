...
lasso_data <- read_excel("~/Desktop/pnet_features/pnet-ep_sp_t1t2.xlsx")
...
```{r}
write.csv(as.data.frame(as.matrix(AllCoeffs)), file = "~/Desktop/pnet-ep_LASSO.csv") ## may not write if path is incorrect
